...
export default function Profile() {
  ...
  if (loading) {
    return (
      <section className="p-6 bg-[#121212] rounded-xl text-gray-400">
...
function StatCard({ icon, label, value }) {
  return (
    <div className="py-8 px-4  bg-surface-muted/30 border border-border-soft rounded-xl hover:shadow-md hover:border-[#3B82F6]/40 hover:-translate-y-0.5 transition-all duration-200 group cursor-pointer flex items-center justify-between mb-3 gap-2">
      {icon}
