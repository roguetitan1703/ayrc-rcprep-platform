 ...
 */
export function FullscreenExitedModal({ onEnterFullscreen }) {
  return (
      ...
      <div className="bg-card-surface rounded-xl shadow-2xl max-w-lg w-full p-8 border-2 border-error-red">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold text-text-primary">Test Requires Fullscreen</h1>
          ...
          <p className="text-xs text-text-secondary">
            ⏸️ Your progress has been saved. The timer is paused until you re-enter fullscreen.
          </p>
        </div>
      </div>
    </div>
