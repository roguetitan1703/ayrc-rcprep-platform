    ...
    <section className="py-24">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-3">
          <a
            href="/register"
            className="px-6 py-3.5 rounded-md bg-accent-amber text-black font-medium text-base"
          >
            {c.ctaPrimary}
          </a>
          <a
            href="/admin"
            className="px-6 py-3.5 rounded-md border border-accent-amber text-accent-amber hover:bg-accent-amber/10 text-base"
          >
            {c.ctaSecondary}
          </a>
        </div>
        <div className="mt-12 grid sm:grid-cols-2 gap-4 text-left">
          <div className="bg-card-surface rounded p-5">
            ...
            <p className="text-sm text-text-secondary">
              Stay consistent with a focused daily routine.
            </p>
          </div>
          <div className="bg-card-surface rounded p-5">
